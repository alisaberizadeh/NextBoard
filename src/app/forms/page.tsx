        ...
        <>
            ...
            <div className='w-full grid grid-cols-2 gap-10 mt-5'>
                <div className='col-span-2 xl:col-span-1 '>
                    <div className=' bg-base-100 rounded-2xl shadow  py-5'>
                        <p className='w-full font-semibold border-b  pb-4 px-5   border-base-300'>Sign In Form</p>
                        <div className='w-full px-5 mt-6'>
                            <label className='w-full block  text-sm'>Email</label>
                            <input type="text" placeholder="Enter your email address  " className="input mt-3 border-base-300 focus:border-neutral outline-none  w-full" />
                        </div>
                        <div className='w-full px-5 mt-6'>
                            <label className='w-full block text-sm'>Password</label>
                            <input type="password" placeholder="Enter your password    " className="input mt-3 border-base-300 focus:border-neutral outline-none  w-full" />
                        </div>
                        <div className='w-full px-5 mt-6 flex items-center justify-between'>
                            <div>
                                <input type="checkbox" id='checkbox' className="checkbox-sm shadow-none rounded-md border-base-300  checkbox checkbox-primary" />
                                <label htmlFor='checkbox' className='text-sm ml-2 cursor-pointer '>Remember me</label>
                            </div>
                            <Link href="" className='text-sm text-primary hover:underline'>Forget password ? Sign In</Link>

                        </div>
                        <div className='w-full px-5 mt-6 '>
                            <button className="btn w-full mb-4 bg-primary focus:outline-none py-6 border-none  text-base-100 ">
                                Sign In
                            </button>
                            <div className='grid grid-cols-2 gap-4'>
                                <button className=" col-span-2 xl:col-span-1 btn w-full mb-4 bg-base-200 focus:outline-none py-6  ">
                                    <svg aria-label="Google logo" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><g><path d="m0 0H512V512H0" fill="#fff"></path><path fill="#34a853" d="M153 292c30 82 118 95 171 60h62v48A192 192 0 0190 341"></path><path fill="#4285f4" d="m386 400a140 175 0 0053-179H260v74h102q-7 37-38 57"></path><path fill="#fbbc02" d="m90 341a208 200 0 010-171l63 49q-12 37 0 73"></path><path fill="#ea4335" d="m153 219c22-69 116-109 179-50l55-54c-78-75-230-72-297 55"></path></g></svg>
                                    Login with Google
                                </button>
                                <button className=" col-span-2 xl:col-span-1 btn w-full mb-4 bg-neutral text-base-100 focus:outline-none py-6  ">
                    ...
                    <div className='mt-10 bg-base-100 rounded-2xl shadow  py-5'>
                        <p className='w-full font-semibold border-b  pb-4 px-5   border-base-300'>  Toggle switch input  </p>
                        <div className='w-full px-5'>


                            <div className=' mt-5'>
                                <label className="toggle mx-1  text-base-content">
                                    <input type="checkbox" />
                                ...
                                <input
                                    defaultChecked
                                    type="checkbox"
                                    className="toggle mx-1   border-primary text-primary checked:border-success checked:bg-success checked:text-success-content"
                                />
                                <input type="checkbox" defaultChecked className="toggle mx-1 toggle-primary" />
                                <input type="checkbox" defaultChecked className="toggle mx-1 toggle-secondary" />
                                <input type="checkbox" defaultChecked className="toggle mx-1 toggle-accent" />
                                <input type="checkbox" defaultChecked className="toggle mx-1 toggle-neutral" />

                                <input type="checkbox" defaultChecked className="toggle mx-1 toggle-info" />
                                <input type="checkbox" defaultChecked className="toggle mx-1 toggle-success" />
                                <input type="checkbox" defaultChecked className="toggle mx-1 toggle-warning" />
                                <input type="checkbox" defaultChecked className="toggle mx-1 toggle-error" />
                            </div>
                        </div>
                ...
                <div className='col-span-2 xl:col-span-1'>
                    <div className=' bg-base-100 rounded-2xl shadow h-full py-5'>
                        <p className='w-full font-semibold border-b  pb-4 px-5   border-base-300'>    Textarea Fields</p>
                        <div className='w-full px-5 mt-6'>
                            <label className='w-full block  text-sm'>Default textarea</label>
                            <textarea className="textarea  focus:border-neutral outline-none  border-base-300  mt-3 w-full" placeholder="Default textarea"></textarea>
                        </div>
                        <div className='w-full px-5 mt-6'>
                            <label className='w-full block  text-sm'>Active textarea</label>
                            <textarea className="textarea textarea-primary focus:none outline-none mt-3 w-full" placeholder="Active textarea"></textarea>
                        </div>
                        <div className='w-full px-5 mt-6'>
                            <label className='w-full block  text-sm'>Disabled  textarea</label>
                            <textarea className="textarea textarea-primary focus:none outline-none mt-3 w-full" disabled placeholder="Disabled textarea"></textarea>
                        </div>
                    </div>
                ...
                <div className='col-span-2 xl:col-span-1'>
                    <div className=' bg-base-100 rounded-2xl shadow h-full py-5'>
                        <p className='w-full font-semibold border-b  pb-4 px-5   border-base-300'>      File upload</p>
                        <div className='w-full px-5 mt-6'>
                            <label className='w-full block  text-sm'>  Attach file</label>
                            <input type='file' className="file-input  focus:shadow-none outline-none  border-base-300  mt-3 w-full" />
                        </div>
                        <div className='w-full px-5 mt-6'>
                            <label className='w-full block  text-sm'>  Disabled file</label>
                            <input type='file' disabled className="file-input  focus:shadow-none outline-none  border-base-300  mt-3 w-full" />
                        </div>
                    </div>
                </div>
                ...
                <div className='col-span-2 xl:col-span-1'>
                    <div className=' bg-base-100 rounded-2xl shadow h-full py-5'>
                        <p className='w-full font-semibold border-b  pb-4 px-5   border-base-300'>Select input  </p>
                        <div className='w-full px-5 mt-6'>
                            <label className='w-full block  text-sm'>  Pick a color  </label>
                            <select defaultValue="Pick a color" className="select  focus:border-neutral outline-none  border-base-300  mt-3 w-full">
                ...
                <div className='col-span-2 xl:col-span-1'>
                    <div className=' bg-base-100 rounded-2xl shadow h-full py-5'>
                        <p className='w-full font-semibold border-b  pb-4 px-5   border-base-300'>Other  input  </p>
                        <div className='w-full grid grid-cols-2 px-5 mt-6 gap-5'>
                            ...
                            <div className='col-span-2 xl:col-span-1'>
                                ...
                                <input type="text" className="input w-full mb-5" placeholder="Which browser do you use" list="browsers" />
                                ...
                                <input type="date" className="input w-full mb-5" />
                            </div>

                            <div className='col-span-2 xl:col-span-1'>
                                <input type="time" className="input w-full mb-5" />
                ...
                <div className='col-span-2 xl:col-span-1'>
                    <div className=' bg-base-100 rounded-2xl shadow h-full py-5'>
                        <p className='w-full font-semibold border-b  pb-4 px-5   border-base-300'>        Login buttons</p>
                        <div className='w-full px-5 mt-6'>
                            <div className='w-full px-5 mt-6'>
                                {/* Email */}
                                <button className="btn w-full mb-5 bg-white text-black border-[#e5e5e5]">
                                ...
                                {/* GitHub */}
                                <button className="btn w-full mb-5 bg-black text-white border-black">
                                    <svg aria-label="GitHub logo" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="white" d="M12,2A10,10 0 0,0 2,12C2,16.42 4.87,20.17 8.84,21.5C9.34,21.58 9.5,21.27 9.5,21C9.5,20.77 9.5,20.14 9.5,19.31C6.73,19.91 6.14,17.97 6.14,17.97C5.68,16.81 5.03,16.5 5.03,16.5C4.12,15.88 5.1,15.9 5.1,15.9C6.1,15.97 6.63,16.93 6.63,16.93C7.5,18.45 8.97,18 9.54,17.76C9.63,17.11 9.89,16.67 10.17,16.42C7.95,16.17 5.62,15.31 5.62,11.5C5.62,10.39 6,9.5 6.65,8.79C6.55,8.54 6.2,7.5 6.75,6.15C6.75,6.15 7.59,5.88 9.5,7.17C10.29,6.95 11.15,6.84 12,6.84C12.85,6.84 13.71,6.95 14.5,7.17C16.41,5.88 17.25,6.15 17.25,6.15C17.8,7.5 17.45,8.54 17.35,8.79C18,9.5 18.38,10.39 18.38,11.5C18.38,15.32 16.04,16.16 13.81,16.41C14.17,16.72 14.5,17.33 14.5,18.26C14.5,19.6 14.5,20.68 14.5,21C14.5,21.27 14.66,21.59 15.17,21.5C19.14,20.16 22,16.42 22,12A10,10 0 0,0 12,2Z"></path></svg>
                                    Login with GitHub
                                </button>
                                ...
                                {/* Facebook */}
                                <button className="btn w-full mb-5 bg-[#1A77F2] text-white border-[#005fd8]">
                                ...
                                {/* Kakao */}
                                <button className="btn w-full mb-5 bg-[#FEE502] text-[#181600] border-[#f1d800]">
                                ...
                                {/* Amazon */}
                                <button className="btn w-full mb-5 bg-[#FF9900] text-black border-[#e17d00]">
                                ...
                                {/* Microsoft */}
                                <button className="btn w-full mb-5 bg-[#2F2F2F] text-white border-black">
                                ...
                                {/* Line */}
                                <button className="btn w-full mb-5 bg-[#03C755] text-white border-[#00b544]">
                                ...
                                {/* Slack */}
                                <button className="btn w-full mb-5 bg-[#622069] text-white border-[#591660]">
                                ...
                                {/* LinkedIn */}
                                <button className="btn w-full mb-5 bg-[#0967C2] text-white border-[#0059b3]">
                                ...
                                {/* VK */}
                                <button className="btn w-full mb-5 bg-[#47698F] text-white border-[#35567b]">
                                ...
                                {/* WeChat */}
                                <button className="btn w-full mb-5 bg-[#5EBB2B] text-white border-[#4eaa0c]">
